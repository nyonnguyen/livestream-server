    ...
    <>
      ...
      >
        <div className="w-full flex flex-col items-center space-y-4 sm:items-end">
          {notification !== null && !dismissed && (
            <div className="max-w-md w-full bg-white shadow-lg rounded-lg pointer-events-auto ring-1 ring-black ring-opacity-5 overflow-hidden animate-fade-in">
              <div className="p-4">
